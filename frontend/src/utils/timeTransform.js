...
export function getRollingTailLen(currentDayOffset, firstDayOfWeek) {
  const raw = currentDayOffset - firstDayOfWeek;
  return Math.max(0, Math.floor(raw / 7) * 7);
}
...
/** @deprecated Use formatDateInShanghai */
